...
<%
	...
	String adminId = (String)session.getAttribute("teacher_id");
%>
<html>
<head>
<title>Q&A 게시판</title>
	...
	<div class="content">
		   ...
		   <tr height="30">
			...
			<%}%> 
		      ...
		      <a href="content.jsp?num=<%=article.getNum()%>&pageNum=<%=currentPage%>">
		         ...
		         <img src="../img/hot.gif" border="0"  height="16"><%}%> </td>
		...
		<%
		    if (count > 0) {
		        ...
		        if (startPage > 10) {    %>
		        <a href="tQNAList.jsp?pageNum=<%= startPage - 10 %>">[이전]</a>
		<%      }
		        for (int i = startPage ; i <= endPage ; i++) {  %>
		        <a href="tQNAList.jsp?pageNum=<%= i %>">[<%= i %>]</a>
		<%
		        }
		        if (endPage < pageCount) {  %>
		        <a href="tQNAList.jsp?pageNum=<%= startPage + 10 %>">[다음]</a>
		<%
		        }
		    }
		%>
