...
<div class="wrapper">
    ...
    <div id="web_bg" style="background-image: url(/Total.Management.System/img/MainDesktop.png);"></div>
		...
		<%
			...
			String teacher_id = null, password= null, auto= null;		// 기본값
			Cookie [] cookies = request.getCookies();
			if(cookies != null) { 						// 자동 로그인 안된 상태면 null이라 form(로그인) 화면 뜸.
				for(Cookie c : cookies) {
					if(c.getName().equals("cid"))
						teacher_id = c.getValue();				// 하나의 명령만 있을땐 {} 생략 가능
			...
			if(auto != null && teacher_id != null && password != null) {
				response.sendRedirect("tcLoginPro.jsp");
			}
		%>
	...
	<div class="container">
		...
		<div class="row">
				...
				<a href="/Total.Management.System/teacher/tcLoginForm.jsp"><p class="thumbnail_align">
						<img src="/Total.Management.System/img/teacher.png" alt="" class="thumbnail" />
					</p></a>
		...
		<form action= "tcLoginPro.jsp" method="post" > 
