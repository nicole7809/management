...
<meta charset="UTF-8">
<title>행정 메인</title>
<link href="/Total.Management.System//css/mainTemplate.css"
...
<body>
	<table border="0" cellpadding="0" cellspacing="0" width="100%"
		align="center">
		<tr>
			<td class="menu"><a href="managementInfo.jsp"> <%=sessionId%>
			</a></td>
			<td align="center" rowspan="6" bgcolor="#EAF6FF">강의리스트에서 여러 반이
				나와서 클릭하면 해당 반 학생리스트가 나오고 거기서 학생정보가 나오는거 아닌가요?<br> 아. 강의리스트 에서 반
				클릭시 맨 위 강사 다음 학생리스트가 나와서 거기서 클릭시 해당 정보가 나오는것???<br> 이렇게
				include하면 되는 거아닌가 왜 안되지? jsp:include
				page="/Total.Management.System/board/notice.jsp"/>
			</td>
		</tr>
		<tr>
			<td class="menu"><a href="courseList.jsp"> 강의리스트</a></td>
		</tr>
		<tr>
			<td class="menu"><a
				href="/Total.Management.System/student/studentList.jsp"> 학생리스트</a></td>
		</tr>
		<tr>
			<td class="menu"><a
				href="/Total.Management.System/board/notice.jsp"> 공지사항 </a></td>
		</tr>
		<tr>
			<td class="menu"><a href="/Total.Management.System/management/QNAList.jsp"> Q & A </a></td>
		</tr>
		<tr>
			<td class="menu"><a href="logout.jsp"> 로그아웃 </a></td>
		</tr>
	...
	<%-- <style>
			...
			.left{float:left;}
			.left ul{ color:#FFFFFF; font-style:normal;  padding-bottom:50px; background-color:#B3B3B3;}
