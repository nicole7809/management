...
<html>
	<head>
		...
		<style>
			.menu{
				background-color:#B3B3B3; width:20%; padding-top:15px; padding-bottom:15px; text-align:center;
			}
	...
	<body>
		<table border ="0" cellpadding="0" cellspacing="0" width="100%" align="center">
			<tr>
				<td class="menu"> <a href ="managementInfo.jsp"> <%=sessionId %> </a></td>
			...
			<tr>
				<td class="menu" > <a href ="/Total.Management.System/student/studentList.jsp"> 학생리스트</a> </td>
			</tr>
			<tr>
