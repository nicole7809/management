	...
	<div class="content">
		<table border="1" cellpadding="0" cellspacing="0" align="center">
			...
			<tr>
				...
				<%-- <a href="../student/studentInfo.jsp?name=<%=sdto.getStudent_id()%>">
						<%=sdto.getStudent_name()%></a> --%>
					<a href="../student/studentInfo.jsp?student_id=<%=sdto.getStudent_id()%>"><%=sdto.getStudent_id()%></a>	
						
						
					<button
						onclick="window.location='stDelete.jsp?student_id=<%=sdto.getStudent_id()%>&state=5'">탈퇴</button>
					<br></td>
				<%
					} // 페이지 값을 학생 아이디로 넘겨줌.
				%>
